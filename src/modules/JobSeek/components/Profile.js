...
const Profile = ({ isHovering }) => (
  <ul className={"profile-list about dropdown-menu " + (isHovering ? "display-dd" : "")}>
    <li>
      <div className="profwidgetsect">
        ...
        <h3 className="name">Aarushi Goyal
          ...
          <span className="progress-span">
            <span className="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">100%
            </span>
          </span>
        </h3>
      </div> 
    ...
    <li className="col-left pd0">
      <ul >
        <li className="xair"><span className="txt12">Industry Reports</span></li>
    ...
    <li className="pd0 col-right col-list">
      <ul className="pd0">
        <li><span className="txt12">About</span></li>
