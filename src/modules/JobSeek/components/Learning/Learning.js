        ...
        <div id="featured" className="featured-div hidden-sm">
          ...
          <div className="pd0">
            <div className="leftnewprofinsecbox">
              <div className="leftnewskillbox">
                <h2 className="profstatbg h2forotherpage txt-display txt-color wd34 ml14" id="profclick">
                  ...
                  {
                    showProfile
                      ? <img className="artogprofstat" src="https://static.iimjobs.com/resources/img/profstatupar.png" id="showupimg" onClick={this.handleIconClick} alt="" />
                      : <img src="https://static.iimjobs.com/resources/img/profstatbelowar.png" className="artogprofstat hidden-sm" id="showbelowimg" onClick={this.handleIconClick} alt=""/> 
                  }
                </h2>
                {showProfile
                  && (
                  <div id="prodisbl" className="prof">
                    <div className="newprofwidgetsect">
                      <span className="media-left media-middle active">
                        <img src="https://edgar.iimjobs.com/media/userpics/2018/09/07/2018-09-07-14-56-22-456800.jpg" className="profsttavtaarimg" alt="" />
                      </span>
                      <h3 className="name-hd">
                        Aarushi Goyal
                        <span className="displaytabemail">
                          aarushi@iimjobs.com
                          <span className="profscore">
                            100%
                          </span>
                        </span>
            ...
            <div className="lefnewskillboxpadb0">
              <a className="a-tag" href="https://learning.iimjobs.com/?ref=tab">
                <h2 className="learningcenterb h2forotherpage txt-color txt-display" id="profclick">
                  Learning Center
                  <img src="https://static.iimjobs.com/resources/img/learar.png" className="arrtlesrcen" alt="" />
                </h2>
              </a>
              <div className="visible-xs" id="prodisbl mt7 visible-xs" />
            </div>
            <div className="ad-div">
              <a className="a-tag" href="https://showcase.iimjobs.com">
          ...
          <div className="sectionHide">
            <div className="pd0 pd5 col-md-12 wd-full">
              ...
              <div className="col-md-12 wd-full pd0">
                <a className="txt-color a-tag">
                  How to identify a 'Talker' from a 'Doer' when you're hiring?
                </a>
                <div className="talent">
                  ...
                  <div className="col-md-2 pd0">
                    <img className="img-circle-small" src="https://allthingstalent.org/wp-content/uploads/2018/05/all-things-talent-powered-by-iimjobs-hirist-160.png" alt="" />
                  </div>
                </div>
              </div>
              <GreyDivider />
              <div className="col-md-12 wd-full pd0">
                <a className="txt-color a-tag">
                  How to deal with and weed out the groupism at your workplace?
                </a>
                <div className="talent">
                  <div className="col-md-10 mt7 txt12 text-right">
                    <span>All Things Talent</span>
